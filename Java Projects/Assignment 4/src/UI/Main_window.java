...
public class Main_window extends JFrame {
			...
			public void mouseClicked(MouseEvent e) {
				...
				while (iter.hasNext()) {
					...
					if (x_settl <= e.getPoint().getX() && e.getPoint().getX() <= x_settl + w_settl
						...
						StatisticWindow statistic_d = statisticWindow(world, s.getName());						statistic_d.setVisible(true);
						break;
					}
	...
	public void menu() throws IOException {
		...
		JMenuItem relog = new JMenuItem("log file resotre");
		...
		load.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					world.setcycle(new CyclicBarrier(world.getSettlements().length, new Runnable() {			
						@Override
						public void run() {
