...
void Data::init()
{
    ...
    while (true)//infinite loop of menu's
    {
        cin.clear();
        cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');//ignore any non-numiric characters
        ...
        case 1://create animal menu
            ...
            cin >> choice_animal;
            switch (choice_animal)//switch between all of the menu's
            {
            case 1:
        ...
        case 2://delete animal menu
            ...
            break;
        case 3://option to find animal by name
            cout << "Enter the name of the animal you want to find: ";
            cin >> find_name;
            print_animal(find_name);
            break;
        case 4://print all animals
            print_all();
            break;
        case 5://check if the both animals can mate
...
//function to find if the animals are the same
